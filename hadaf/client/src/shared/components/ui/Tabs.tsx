...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      'data-[state=active]:bg-background-paper dark:data-[state=active]:bg-background-paper-dark',
      'data-[state=active]:text-foreground dark:data-[state=active]:text-foreground-dark',
