...
// /goals — Goal CRUD shell (E1 fills content; this is the route stub).
// Reuses the "Coming Soon" overlay pattern from DashboardPage so the route
// is reachable from the shell without a hard-redirect.
