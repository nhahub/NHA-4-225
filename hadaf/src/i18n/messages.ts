...
export const messages = {
  ar: {
    ...
    goals: {
      ...
      heatmapTitle: "الخريطة الحرارية للمهام",
      heatmapHelper:
        "كل خلية تمثل عدد المهام المكتملة في أسبوع من الدورة. الأسبوع الحالي بإطار أوضح.",
      heatmapEmpty: "أكمل بعض المهام المرتبطة لتفعيل الخريطة الحرارية.",
      heatmapWeekN: "الأسبوع {n}",
      searchPlaceholder: "ابحث في الأهداف (العنوان أو الفئة)…",
      searchNoResults: "لا أهداف مطابقة لـ «{query}».",
    ...
    newGoal: {
      ...
      successToast: "تم حفظ الهدف. افتح الكونسول لرؤية البيانات.",
    ...
    goalDetail: {
      ...
      manualOverrideTitle: "تعديل التقدم يدويًا",
      manualOverrideHelper:
        "اسحب لتحديد نسبة تقدّمك يدويًا. ستظهر شارة «يدوي» على الهدف حتى تعيد للقيمة المحسوبة.",
      manualBadge: "يدوي",
      manualOverrideRevert: "العودة إلى القيمة المحسوبة",
      manualOverrideComputedLabel: "القيمة المحسوبة",
      manualOverrideActiveLabel: "القيمة اليدوية",
      manualOverrideSuccess: "تم حفظ التقدّم اليدوي.",
      manualOverrideError: "تعذّر حفظ التقدّم اليدوي. حاول مرة أخرى.",
      deleteTitle: "حذف الهدف",
      deleteHelper:
        "سيتم أرشفة الهدف وإخفاؤه من لوحة الأهداف. يمكنك ذكر السبب للرجوع إليه لاحقًا.",
      deleteReasonLabel: "سبب الحذف",
      deleteReasonPlaceholder: "مثال: لم يعد ذا صلة، أو ضيق الوقت…",
      deleteConfirm: "أرشف الهدف",
      deleteSuccess: "تم أرشفة الهدف.",
      deleteError: "تعذّر أرشفة الهدف. حاول مرة أخرى.",
      tasksCompletedUnit: "مهام",
      linkedTasksEmpty: "لا مهام مرتبطة بهذا الهدف بعد.",
      linkedTasksViewAll: "كل المهام",
    },
    commonWeekBar: {
  ...
  en: {
    ...
    goals: {
      ...
      heatmapTitle: "Task heat map",
      heatmapHelper:
        "Each cell is the number of tasks you completed in that week of the cycle. The current week has a clearer frame.",
      heatmapEmpty:
        "Complete some linked tasks to fill in the heat map.",
      heatmapWeekN: "Week {n}",
      searchPlaceholder: "Search goals (title or category)…",
      searchNoResults: "No goals match “{query}”.",
    ...
    newGoal: {
      ...
      successToast: "Goal saved. Open the console to see the payload.",
    ...
    goalDetail: {
      ...
      manualOverrideTitle: "Override progress manually",
      manualOverrideHelper:
        "Drag to set your progress manually. A “Manual” badge stays on the goal until you revert.",
      manualBadge: "Manual",
      manualOverrideRevert: "Revert to computed value",
      manualOverrideComputedLabel: "Computed",
      manualOverrideActiveLabel: "Manual",
      manualOverrideSuccess: "Manual progress saved.",
      manualOverrideError: "Couldn't save the manual progress. Please try again.",
      deleteTitle: "Delete goal",
      deleteHelper:
        "This archives the goal and removes it from your dashboard. Add a reason so you can remember later.",
      deleteReasonLabel: "Reason for deletion",
      deleteReasonPlaceholder: "e.g., no longer relevant, time pressure…",
      deleteConfirm: "Archive goal",
      deleteSuccess: "Goal archived.",
      deleteError: "Couldn't archive the goal. Please try again.",
      tasksCompletedUnit: "tasks",
      linkedTasksEmpty: "No tasks linked to this goal yet.",
      linkedTasksViewAll: "All tasks",
    },
    commonWeekBar: {
